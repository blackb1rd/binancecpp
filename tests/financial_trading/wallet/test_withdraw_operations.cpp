/*
    Unit test for withdraw_operations.cpp
...
int main()
{
    std::cout << "=== Testing withdraw_operations ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for withdraw_operations functions
    ...
    std::cout << "\n=== withdraw_operations Tests Complete ===" << std::endl;
