/*
    Unit test for create_listen_key.cpp
...
int main()
{
    std::cout << "=== Testing create_listen_key ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for create_listen_key functions
    ...
    std::cout << "\n=== create_listen_key Tests Complete ===" << std::endl;
