/*
    Unit test for get_account_information.cpp
...
int main()
{
    std::cout << "=== Testing get_account_information ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for get_account_information functions
    ...
    std::cout << "\n=== get_account_information Tests Complete ===" << std::endl;
