/*
    Unit test for get_system_status.cpp
...
int main()
{
    std::cout << "=== Testing get_system_status ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for get_system_status functions
    ...
    std::cout << "\n=== get_system_status Tests Complete ===" << std::endl;
