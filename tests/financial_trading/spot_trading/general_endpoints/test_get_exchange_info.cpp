/*
    Unit test for get_exchange_info.cpp
...
int main()
{
    std::cout << "=== Testing get_exchange_info ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for get_exchange_info functions
    ...
    std::cout << "\n=== get_exchange_info Tests Complete ===" << std::endl;
