/*
    Unit test for get_rolling_window_price_change_statistics_all.cpp
...
int main()
{
    std::cout << "=== Testing get_rolling_window_price_change_statistics_all ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for get_rolling_window_price_change_statistics_all functions
    ...
    std::cout << "\n=== get_rolling_window_price_change_statistics_all Tests Complete ===" << std::endl;
