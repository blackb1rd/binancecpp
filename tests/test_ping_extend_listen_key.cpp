/*
    Unit test for ping_extend_listen_key.cpp
...
int main()
{
    std::cout << "=== Testing ping_extend_listen_key ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for ping_extend_listen_key functions
    ...
    std::cout << "\n=== ping_extend_listen_key Tests Complete ===" << std::endl;
