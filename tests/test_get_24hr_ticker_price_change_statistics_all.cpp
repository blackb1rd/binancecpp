/*
    Unit test for get_24hr_ticker_price_change_statistics_all.cpp
...
int main()
{
    std::cout << "=== Testing get_24hr_ticker_price_change_statistics_all ===" << std::endl;
    ...
    try 
    {
        // TODO: Add specific tests for get_24hr_ticker_price_change_statistics_all functions
    ...
    std::cout << "\n=== get_24hr_ticker_price_change_statistics_all Tests Complete ===" << std::endl;
