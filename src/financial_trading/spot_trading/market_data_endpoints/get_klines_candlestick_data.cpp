/*
        ...
        Implementation of klines/candlestick data endpoint for Spot Trading
*/
...
void TradeData::GetKlinesCandlestickData(std::string_view symbol, std::string_view interval, int limit,
                                        time_t startTime, time_t endTime, Json::Value& json_result) {
  BinanceCPP_logger::write_log("<TradeData::GetKlinesCandlestickData>");
  
  std::string url = std::string(BINANCE_HOST) + "/api/v3/klines?symbol=" + std::string(symbol) + 
